...
public class EncryptUtil
{
    ...
    public static HashMap decode(String code) throws Exception
    {
        String resultCode = "";
        String remark = "";
        ...
        if (code != null && !"".equals(code))
        {
            try
            {
                // System.out.println("加密=========="+EncryptUtil.encryptByDES("qdyth3533",EncryptUtil.SECURITY_KEY));
                //
                // System.out.println("解密==========" +
                // EncryptUtil.decryptByDES(code, EncryptUtil.SECURITY_KEY));

                // 1:掉接口是我会传passwd参数 passwd=1544E434D857874B714DCAC09DA17924
                // 2:拿到passwd参数后进行解密
                String passwd = EncryptUtil.decryptByDES(code, EncryptUtil.SECURITY_KEY);
                if ("qdyth3533".equals(passwd))
                {
                    resultCode = "000";
                    remark = "验证成功";
                }
            ...
            catch (Exception e)
            {
                ...
                remark += e.toString();
                System.out.println("catch: " + e.getCause().toString());
            }
            finally
            {
    ...
    public static String encryptByMD5(String plaintext) throws NoSuchAlgorithmException, UnsupportedEncodingException
    {
        ...
        String hexStr = byteArray2HexStr(data);
        return hexStr;
    }

    public static String encryptByMD5(String plaintext, String charset)
